<div class="sidebar-wrapper" data-simplebar="true">
    <div class="sidebar-header">
        ...
        <div>
            <h4 class="logo-text">Madiyanv</h4>
        </div>
    ...
    <ul class="metismenu" id="menu">
        <li>
            <a href="javascript:;" class="has-arrow">
                <div class=""><i class='bx bx-home-alt'></i>
                </div>
        ...
        <li>
            <a href="javascript:;" class="has-arrow">
                ...
                <div class="menu-title">Vidéo Acceuil</div>
            </a>
            <ul>
                <li> <a href=" {{route('add.video')}} "><i class='bx bx-radio-circle'></i>Ajouter Video</a>
                </li> 
